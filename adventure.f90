...
PROGRAM ADVENTURE
   ...
   CHARACTER*5 argument
   CHARACTER*5 B,WD2,ATAB
   REAL RAN

   DIMENSION IOBJ(300),ICHAIN(100),IPLACE(100),IFIXED(100),COND(300),PROP(100),ABB(300),LTEXT(300),STEXT(300), &
      KEY(300),TRAVEL(1000),TK(25),KTAB(1000),ATAB(1000),BTEXT(200),DSEEN(10),DLOC(10),ODLOC(10),DTRAV(20),JSPKT(100),&
      IPLT(100),IFIXT(100)

   LOGICAL LOCOUT ! Print out location numbers
   ...
   DATA(DTRAV(I),I=1,20)/36,28,19,30,62,60,41,27,17,15,19,28,36,300,300,5*0/
   DATA KEY /300*0/
...
! PARSE COMMAND LINE ARGS
   DO I=1,IARGC()
      ...
      IF (argument .EQ. '-LOC' .OR. argument .EQ. '-loc') LOCOUT=.TRUE.
   END DO
...
2020 CALL GETIN(TWOWDS, argument, WD2, B)
   K=70
   IF(argument .EQ.'ENTER' .AND. (WD2.EQ.'STREA'.OR.WD2.EQ.'WATER')) GOTO 2010
   IF(argument .EQ.'ENTER'.AND.TWOWDS.NE.0) GOTO 2012
