...
PROGRAM ADVENTURE
   ...
   REAL RAN
   COMMON RTEXT,LLINE
   DIMENSION IOBJ(300),ICHAIN(100),IPLACE(100),IFIXED(100),COND(300),PROP(100),ABB(300),LLINE(1000,22),LTEXT(300),STEXT(300), &
      KEY(300),TRAVEL(1000),TK(25),KTAB(1000),ATAB(1000),BTEXT(200),DSEEN(10),DLOC(10),ODLOC(10),DTRAV(20),RTEXT(100),JSPKT(100),&
      IPLT(100),IFIXT(100)
   LOGICAL LOCOUT
   CHARACTER CHRS*4
